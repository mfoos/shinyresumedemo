...
`r if(length(params$watcher_strings) > 0){"**Vampire Slayer**  
**Watchers Council, Sunnydale, CA (remote)**  
October 1996 – Present"}`  

`r if(length(params$watcher_strings) > 0){paste0("* ", paste(params$watcher_strings, collapse = "\n* "))}`
